...
export const OrderMovie = (props) => {
    ...
    return (
        <div className={css.OrderMovie}>
            ...
            style={{transform:canUserResumeToOrderChair===true?'translateY(-100vh)':
            'translateY(0vh)'}}
             >
                ...
                <div style={{display:canUserResumeToAdultAndKidsForm===true?"flex":"none",
            ...
            <div
               ...
               <Link to="/">
               <button onClick={takeOrder}><BsCart3/></button> 
               </Link>          
            </div> 
